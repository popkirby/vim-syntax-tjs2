...
syntax keyword tjs2Typedef          this super global var
...
syntax keyword tjs2Reserved         const debugger export enum finally import in octet protected private public synchronized static
...
" Comments
syntax region  tjs2Comment          start="/\*" end="\*/"
...
syntax region  tjs2Bracket          matchgroup=tjs2Bracket transparent start="\[" end="\]" contains=@tjs2Top,tjs2Bracket,tjs2Paren,tjs2Block,tjs2ParensErrB,tjs2ParensErrC
syntax region  tjs2Paren            matchgroup=tjs2Paren   transparent start="("  end=")"  contains=@tjs2Top,tjs2Bracket,tjs2Paren,tjs2Block,tjs2ParensErrA,tjs2ParensErrC
syntax region  tjs2Block            matchgroup=tjs2Block   transparent start="{"  end="}"  contains=@tjs2Top,tjs2Bracket,tjs2Paren,tjs2Block,tjs2ParensErrA,tjs2ParensErrB
...
if version >= 508 || !exists("did_tjs2_syn_inits")
  ...
  TJS2HiLink tjs2Typedef            Typedef
